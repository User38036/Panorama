...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		el=me._info_popup_3galery=document.createElement('div');
		el.ggId="info_popup_3Galery";
		...
		me._info_popup_3galery.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._info_popup_3galery.ggUpdatePosition=function (useTransition) {
		}
		...
		el=me._btn_close_reading_3=document.createElement('div');
		els=me._btn_close_reading_3__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="btn_close_reading_3";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		...
		me._btn_close_reading_3.ggUpdateText=function() {
			var params = [];
		...
		me._btn_close_reading_3.ggUpdateText();
		el.appendChild(els);
		me._btn_close_reading_3.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._btn_close_reading_3.onclick=function (e) {
			if (player.transitionsDisabled) {
				me._info_popup_3galery.style.transition='none';
			} else {
				me._info_popup_3galery.style.transition='all 400ms ease-out 0ms';
			}
			me._info_popup_3galery.ggParameter.rx=0;me._info_popup_3galery.ggParameter.ry=0;
			me._info_popup_3galery.style.transform=parameterToTransform(me._info_popup_3galery.ggParameter);
		}
		me._btn_close_reading_3.ggUpdatePosition=function (useTransition) {
		}
		me._rectangle_3.appendChild(me._btn_close_reading_3);
		el=me._text_scroll_reading_3=document.createElement('div');
		els=me._text_scroll_reading_3__content=document.createElement('div');
		...
		hs+="";
		els.setAttribute('style',hs);
		me._text_scroll_reading_3.ggScrollByX = function(diffX) {
			if(!me._text_scroll_reading_3.ggHorScrollVisible || diffX == 0 || me._text_scroll_reading_3.ggHPercentVisible >= 1.0) return;
			me._text_scroll_reading_3.ggScrollPosX = (me._text_scroll_reading_3__horScrollFg.offsetLeft + diffX);
			me._text_scroll_reading_3.ggScrollPosX = Math.max(me._text_scroll_reading_3.ggScrollPosX, 0);
			me._text_scroll_reading_3.ggScrollPosX = Math.min(me._text_scroll_reading_3.ggScrollPosX, me._text_scroll_reading_3__horScrollBg.offsetWidth - me._text_scroll_reading_3__horScrollFg.offsetWidth);
			me._text_scroll_reading_3__horScrollFg.style.left = me._text_scroll_reading_3.ggScrollPosX + 'px';
			let percentScrolled = me._text_scroll_reading_3.ggScrollPosX / (me._text_scroll_reading_3__horScrollBg.offsetWidth - me._text_scroll_reading_3__horScrollFg.offsetWidth);
			me._text_scroll_reading_3__content.style.left = -(Math.round((me._text_scroll_reading_3.ggContentWidth * (1.0 - me._text_scroll_reading_3.ggHPercentVisible)) * percentScrolled)) + me._text_scroll_reading_3.ggContentLeftOffset + 'px';
			me._text_scroll_reading_3.ggScrollPosXPercent = (me._text_scroll_reading_3__horScrollFg.offsetLeft / me._text_scroll_reading_3__horScrollBg.offsetWidth);
		}
		me._text_scroll_reading_3.ggScrollByXSmooth = function(diffX) {
			if(!me._text_scroll_reading_3.ggHorScrollVisible || diffX == 0 || me._text_scroll_reading_3.ggHPercentVisible >= 1.0) return;
			var scrollPerInterval = diffX / 25;
			var scrollCurrX = 0;
			var id = setInterval(function() {
				scrollCurrX += scrollPerInterval;
				me._text_scroll_reading_3.ggScrollPosX += scrollPerInterval;
				if (diffX > 0 && (scrollCurrX >= diffX || me._text_scroll_reading_3.ggScrollPosX >= me._text_scroll_reading_3__horScrollBg.offsetWidth - me._text_scroll_reading_3__horScrollFg.offsetWidth)) {
					me._text_scroll_reading_3.ggScrollPosX = Math.min(me._text_scroll_reading_3.ggScrollPosX, me._text_scroll_reading_3__horScrollBg.offsetWidth - me._text_scroll_reading_3__horScrollFg.offsetWidth);
					clearInterval(id);
				}
				if (diffX < 0 && (scrollCurrX <= diffX || me._text_scroll_reading_3.ggScrollPosX <= 0)) {
					me._text_scroll_reading_3.ggScrollPosX = Math.max(me._text_scroll_reading_3.ggScrollPosX, 0);
					clearInterval(id);
				}
			me._text_scroll_reading_3__horScrollFg.style.left = me._text_scroll_reading_3.ggScrollPosX + 'px';
		...
		me._text_scroll_reading_3.ggScrollByY = function(diffY) {
			if(!me._text_scroll_reading_3.ggVertScrollVisible || diffY == 0 || me._text_scroll_reading_3.ggVPercentVisible >= 1.0) return;
			me._text_scroll_reading_3.ggScrollPosY = (me._text_scroll_reading_3__vertScrollFg.offsetTop + diffY);
			me._text_scroll_reading_3.ggScrollPosY = Math.max(me._text_scroll_reading_3.ggScrollPosY, 0);
			me._text_scroll_reading_3.ggScrollPosY = Math.min(me._text_scroll_reading_3.ggScrollPosY, me._text_scroll_reading_3__vertScrollBg.offsetHeight - me._text_scroll_reading_3__vertScrollFg.offsetHeight);
			me._text_scroll_reading_3__vertScrollFg.style.top = me._text_scroll_reading_3.ggScrollPosY + 'px';
			let percentScrolled = me._text_scroll_reading_3.ggScrollPosY / (me._text_scroll_reading_3__vertScrollBg.offsetHeight - me._text_scroll_reading_3__vertScrollFg.offsetHeight);
			me._text_scroll_reading_3__content.style.top = -(Math.round((me._text_scroll_reading_3.ggContentHeight * (1.0 - me._text_scroll_reading_3.ggVPercentVisible)) * percentScrolled)) + me._text_scroll_reading_3.ggContentTopOffset + 'px';
			me._text_scroll_reading_3.ggScrollPosYPercent = (me._text_scroll_reading_3__vertScrollFg.offsetTop / me._text_scroll_reading_3__vertScrollBg.offsetHeight);
		}
		me._text_scroll_reading_3.ggScrollByYSmooth = function(diffY) {
			if(!me._text_scroll_reading_3.ggVertScrollVisible || diffY == 0 || me._text_scroll_reading_3.ggVPercentVisible >= 1.0) return;
			var scrollPerInterval = diffY / 25;
			var scrollCurrY = 0;
			var id = setInterval(function() {
				scrollCurrY += scrollPerInterval;
				me._text_scroll_reading_3.ggScrollPosY += scrollPerInterval;
				if (diffY > 0 && (scrollCurrY >= diffY || me._text_scroll_reading_3.ggScrollPosY >= me._text_scroll_reading_3__vertScrollBg.offsetHeight - me._text_scroll_reading_3__vertScrollFg.offsetHeight)) {
					me._text_scroll_reading_3.ggScrollPosY = Math.min(me._text_scroll_reading_3.ggScrollPosY, me._text_scroll_reading_3__vertScrollBg.offsetHeight - me._text_scroll_reading_3__vertScrollFg.offsetHeight);
					clearInterval(id);
				}
				if (diffY < 0 && (scrollCurrY <= diffY || me._text_scroll_reading_3.ggScrollPosY <= 0)) {
					me._text_scroll_reading_3.ggScrollPosY = Math.max(me._text_scroll_reading_3.ggScrollPosY, 0);
					clearInterval(id);
				}
			me._text_scroll_reading_3__vertScrollFg.style.top = me._text_scroll_reading_3.ggScrollPosY + 'px';
		...
		me._text_scroll_reading_3.ggScrollIntoView = function(posX, posY, width, height) {
			if (me._text_scroll_reading_3.ggHorScrollVisible) {
				if (posX < 0) {
					var diffX = Math.floor(posX * me._text_scroll_reading_3.ggHPercentVisible);
					me._text_scroll_reading_3.ggScrollByXSmooth(diffX);
				} else if (posX + width > me._text_scroll_reading_3.clientWidth - (me._text_scroll_reading_3.ggVertScrollVisible ? 15 : 0)) {
					var diffX = Math.ceil(((posX + width) - (me._text_scroll_reading_3.clientWidth - (me._text_scroll_reading_3.ggVertScrollVisible ? 15 : 0))) * me._text_scroll_reading_3.ggHPercentVisible);
					me._text_scroll_reading_3.ggScrollByXSmooth(diffX);
				}
			}
			if (me._text_scroll_reading_3.ggVertScrollVisible) {
				if (posY < 0) {
					var diffY = Math.floor(posY * me._text_scroll_reading_3.ggVPercentVisible);
					me._text_scroll_reading_3.ggScrollByYSmooth(diffY);
				} else if (posY + height > me._text_scroll_reading_3.clientHeight - (me._text_scroll_reading_3.ggHorScrollVisible ? 15 : 0)) {
					var diffY = Math.ceil(((posY + height) - (me._text_scroll_reading_3.clientHeight - (me._text_scroll_reading_3.ggHorScrollVisible ? 15 : 0))) * me._text_scroll_reading_3.ggVPercentVisible);
					me._text_scroll_reading_3.ggScrollByYSmooth(diffY);
				}
			}
		}
		me._text_scroll_reading_3__content.mousetouchend = e => {
			let inertiaInterval = setInterval(function() {
				me._text_scroll_reading_3.ggDragInertiaX *= 0.96;
				me._text_scroll_reading_3.ggDragInertiaY *= 0.96;
				me._text_scroll_reading_3.ggScrollByX(me._text_scroll_reading_3.ggDragInertiaX);
				me._text_scroll_reading_3.ggScrollByY(me._text_scroll_reading_3.ggDragInertiaY);
				if (Math.abs(me._text_scroll_reading_3.ggDragInertiaX) < 1.0 && Math.abs(me._text_scroll_reading_3.ggDragInertiaY) < 1.0) {
					clearInterval(inertiaInterval);
				}
				}, 10);
			me._text_scroll_reading_3__content.onmouseup = null;
			me._text_scroll_reading_3__content.onmousemove = null;
			me._text_scroll_reading_3__content.ontouchend = null;
			me._text_scroll_reading_3__content.ontouchmove = null;
			me._text_scroll_reading_3__content.onpointerup = null;
			me._text_scroll_reading_3__content.onpointermove = null;
			setTimeout(function() { me._text_scroll_reading_3.ggIsDragging = false; }, 100);
		}
		me._text_scroll_reading_3__content.mousetouchmove = e => {
			e = e || window.event;
			e.preventDefault();
			var t = e.touches;
			var eventX = t ? t[0].clientX : e.clientX;
			var eventY = t ? t[0].clientY : e.clientY;
			if (Math.abs(eventX - me._text_scroll_reading_3.ggDragStartX) > 10 || Math.abs(eventY - me._text_scroll_reading_3.ggDragStartY) > 10) me._text_scroll_reading_3.ggIsDragging = true;
			var diffX = (eventX - me._text_scroll_reading_3.ggDragLastX) * me._text_scroll_reading_3.ggHPercentVisible;
			var diffY = (eventY - me._text_scroll_reading_3.ggDragLastY) * me._text_scroll_reading_3.ggVPercentVisible;
			me._text_scroll_reading_3.ggDragInertiaX = -diffX;
			me._text_scroll_reading_3.ggDragInertiaY = -diffY;
			me._text_scroll_reading_3.ggDragLastX = eventX;
			me._text_scroll_reading_3.ggDragLastY = eventY;
			me._text_scroll_reading_3.ggScrollByX(-diffX);
			me._text_scroll_reading_3.ggScrollByY(-diffY);
		}
		me._text_scroll_reading_3__content.mousetouchstart = e => {
			e = e || window.event;
			var t = e.touches;
			me._text_scroll_reading_3.ggDragLastX = me._text_scroll_reading_3.ggDragStartX = t ? t[0].clientX : e.clientX;
			me._text_scroll_reading_3.ggDragLastY = me._text_scroll_reading_3.ggDragStartY = t ? t[0].clientY : e.clientY;
			me._text_scroll_reading_3__content.onmouseup = me._text_scroll_reading_3__content.mousetouchend;
			me._text_scroll_reading_3__content.ontouchend = me._text_scroll_reading_3__content.mousetouchend;
			me._text_scroll_reading_3__content.onmousemove = me._text_scroll_reading_3__content.mousetouchmove;
			me._text_scroll_reading_3__content.ontouchmove = me._text_scroll_reading_3__content.mousetouchmove;
			if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
				me._text_scroll_reading_3__content.onpointerup = me._text_scroll_reading_3__content.ontouchend;
				me._text_scroll_reading_3__content.onpointermove = me._text_scroll_reading_3__content.ontouchmove;
			}
		}
		els.onmousedown = me._text_scroll_reading_3__content.mousetouchstart;
		els.ontouchstart = me._text_scroll_reading_3__content.mousetouchstart;
		if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
			els.onpointerdown = me._text_scroll_reading_3__content.mousetouchstart;
		}
		elHorScrollBg = me._text_scroll_reading_3__horScrollBg = document.createElement('div');
		el.appendChild(elHorScrollBg);
		elHorScrollBg.setAttribute('style', 'position: absolute; left: 0px; bottom: 0px; visibility: hidden; width: 612px; height: 15px; background-color: rgba(128,128,128,1); pointer-events: auto;');
		elHorScrollBg.className='ggskin ggskin_scrollarea_hscrollbg';
		elHorScrollFg = me._text_scroll_reading_3__horScrollFg = document.createElement('div');
		elHorScrollBg.appendChild(elHorScrollFg);
		elHorScrollFg.className='ggskin ggskin_scrollarea_hscrollfg';
		elHorScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 612px; height: 15px; background-color: rgba(192,192,192,1); pointer-events: auto;');
		me._text_scroll_reading_3.ggScrollPosX = 0;
		me._text_scroll_reading_3.ggScrollPosXPercent = 0.0;
		elHorScrollFg.onmousedown = function(e) {
			if (player.getOS() == 1 && navigator.maxTouchPoints > 0) return;
			e = e || window.event;
			e.preventDefault();
			e.stopPropagation();
			me._text_scroll_reading_3.ggDragLastX = e.clientX;
			document.onmouseup = function() {
				let inertiaInterval = setInterval(function() {
					me._text_scroll_reading_3.ggDragInertiaX *= 0.96;
					me._text_scroll_reading_3.ggScrollByX(me._text_scroll_reading_3.ggDragInertiaX);
					if (Math.abs(me._text_scroll_reading_3.ggDragInertiaX) < 1.0) {
						clearInterval(inertiaInterval);
					}
					}, 10);
			...
			document.onmousemove = function(e) {
				e = e || window.event;
				e.preventDefault();
				var diffX = e.clientX - me._text_scroll_reading_3.ggDragLastX;
				me._text_scroll_reading_3.ggDragInertiaX = diffX;
				me._text_scroll_reading_3.ggDragLastX = e.clientX;
				me._text_scroll_reading_3.ggScrollByX(diffX);
			}
		...
		elHorScrollFg.ontouchstart = function(e) {
			...
			e.stopPropagation();
			var t = e.touches;
			me._text_scroll_reading_3.ggDragLastX = t ? t[0].clientX : e.clientX;
			...
			document.ontouchmove = function(e) {
				...
				e.preventDefault();
				var t = e.touches;
				var diffX = (t ? t[0].clientX : e.clientX) - me._text_scroll_reading_3.ggDragLastX;
				me._text_scroll_reading_3.ggDragInertiaX = diffX;
				me._text_scroll_reading_3.ggDragLastX = t ? t[0].clientX : e.clientX;
				me._text_scroll_reading_3.ggScrollByX(diffX);
			}
		...
		elHorScrollBg.onmousedown = function(e) {
			e = e || window.event;
			e.preventDefault();
			var diffX = me._text_scroll_reading_3.ggScrollWidth;
			if (e.offsetX < me._text_scroll_reading_3.ggScrollPosX) {
				diffX = diffX * -1;
			}
			me._text_scroll_reading_3.ggScrollByXSmooth(diffX);
		}
		elHorScrollBg.ontouchstart = function(e) {
			...
			e.stopPropagation();
			var t = e.touches;
			var rect = me._text_scroll_reading_3__horScrollBg.getBoundingClientRect();
			var diffX = me._text_scroll_reading_3.ggScrollWidth;
			if ((t[0].clientX - rect.left) < me._text_scroll_reading_3.ggScrollPosX) {
				diffX = diffX * -1;
			}
			me._text_scroll_reading_3.ggScrollByXSmooth(diffX);
		}
		el.addEventListener('wheel', function(e) {
			...
			me._text_scroll_reading_3.ggScrollByXSmooth(30 * me._text_scroll_reading_3.ggHPercentVisible * wheelDelta);
		});
		elVertScrollBg = me._text_scroll_reading_3__vertScrollBg = document.createElement('div');
		el.appendChild(elVertScrollBg);
		elVertScrollBg.setAttribute('style', 'position: absolute; right: 0px; top: 0px; visibility: hidden; width: 15px; height: 197px; background-color: rgba(128,128,128,1); pointer-events: auto;');
		elVertScrollBg.className='ggskin ggskin_scrollarea_vscrollbg';
		elVertScrollFg = me._text_scroll_reading_3__vertScrollFg = document.createElement('div');
		elVertScrollBg.appendChild(elVertScrollFg);
		elVertScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 15px; height: 197px; background-color: rgba(192,192,192,1); pointer-events: auto;');
		elVertScrollFg.className='ggskin ggskin_scrollarea_vscrollfg';
		me._text_scroll_reading_3.ggScrollPosY = 0;
		me._text_scroll_reading_3.ggScrollPosYPercent = 0.0;
		elVertScrollFg.onmousedown = function(e) {
			if (player.getOS() == 1 && navigator.maxTouchPoints > 0) return;
			e = e || window.event;
			e.preventDefault();
			e.stopPropagation();
			me._text_scroll_reading_3.ggDragLastY = e.clientY;
			document.onmouseup = function() {
				let inertiaInterval = setInterval(function() {
					me._text_scroll_reading_3.ggDragInertiaY *= 0.96;
					me._text_scroll_reading_3.ggScrollByY(me._text_scroll_reading_3.ggDragInertiaY);
					if (Math.abs(me._text_scroll_reading_3.ggDragInertiaY) < 1.0) {
						clearInterval(inertiaInterval);
					}
					}, 10);
				document.onmouseup = null;
			...
			document.onmousemove = function(e) {
				e = e || window.event;
				e.preventDefault();
				var diffY = e.clientY - me._text_scroll_reading_3.ggDragLastY;
				me._text_scroll_reading_3.ggDragInertiaY = diffY;
				me._text_scroll_reading_3.ggDragLastY = e.clientY;
				me._text_scroll_reading_3.ggScrollByY(diffY);
			}
		...
		elVertScrollFg.ontouchstart = function(e) {
			...
			e.stopPropagation();
			var t = e.touches;
			me._text_scroll_reading_3.ggDragLastY = t ? t[0].clientY : e.clientY;
			document.ontouchend = function() {
				let inertiaInterval = setInterval(function() {
					me._text_scroll_reading_3.ggDragInertiaY *= 0.96;
					me._text_scroll_reading_3.ggScrollByY(me._text_scroll_reading_3.ggDragInertiaY);
			...
			document.ontouchmove = function(e) {
				...
				e.preventDefault();
				var t = e.touches;
				var diffY = (t ? t[0].clientY : e.clientY) - me._text_scroll_reading_3.ggDragLastY;
				me._text_scroll_reading_3.ggDragInertiaY = diffY;
				me._text_scroll_reading_3.ggDragLastY = t ? t[0].clientY : e.clientY;
				me._text_scroll_reading_3.ggScrollByY(diffY);
			}
		...
		elVertScrollBg.onmousedown = function(e) {
			e = e || window.event;
			e.preventDefault();
			var diffY = me._text_scroll_reading_3.ggScrollHeight;
			if (e.offsetY < me._text_scroll_reading_3.ggScrollPosY) {
				diffY = diffY * -1;
			}
			me._text_scroll_reading_3.ggScrollByYSmooth(diffY);
		}
		elVertScrollBg.ontouchstart = function(e) {
			...
			e.stopPropagation();
			var t = e.touches;
			var rect = me._text_scroll_reading_3__vertScrollBg.getBoundingClientRect();
			var diffY = me._text_scroll_reading_3.ggScrollHeight;
			if ((t[0].clientY - rect.top) < me._text_scroll_reading_3.ggScrollPosY) {
				diffY = diffY * -1;
			}
			me._text_scroll_reading_3.ggScrollByYSmooth(diffY);
		}
		el.addEventListener('wheel', function(e) {
			...
			me._text_scroll_reading_3.ggScrollByYSmooth(30 * me._text_scroll_reading_3.ggVPercentVisible * wheelDelta);
		});
		elCornerBg = me._text_scroll_reading_3__cornerBg = document.createElement('div');
		el.appendChild(elCornerBg);
		elCornerBg.setAttribute('style', 'position: absolute; right: 0px; bottom: 0px; visibility: hidden; width: 15px; height: 15px; background-color: rgba(255,255,255,1);');
		elCornerBg.className='ggskin ggskin_scrollarea_scrollcorner';
		el.ggId="text_scroll_reading_3";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._text_scroll_reading_3.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._text_scroll_reading_3.ggUpdatePosition=function (useTransition) {
			{
			...
			var scaleY = this.getBoundingClientRect().height / this.offsetHeight;
				...
				this.ggContent.style.left = -(Math.round(me._text_scroll_reading_3.ggScrollPosX / me._text_scroll_reading_3.ggHPercentVisible)) + this.ggContentLeftOffset + 'px';
				this.ggContent.style.marginLeft = '0px';
				this.ggContent.style.top = -(Math.round(me._text_scroll_reading_3.ggScrollPosY / me._text_scroll_reading_3.ggVPercentVisible)) + this.ggContentTopOffset + 'px';
				this.ggContent.style.marginTop = '0px';
				if (contentWidth > Math.ceil(offsetWidthWithScale)) {
					me._text_scroll_reading_3__horScrollBg.style.visibility = 'inherit';
					me._text_scroll_reading_3__horScrollFg.style.visibility = 'inherit';
					me._text_scroll_reading_3.ggHorScrollVisible = true;
				} else {
					me._text_scroll_reading_3__horScrollBg.style.visibility = 'hidden';
					me._text_scroll_reading_3__horScrollFg.style.visibility = 'hidden';
					me._text_scroll_reading_3.ggHorScrollVisible = false;
				}
				if ((me._text_scroll_reading_3.ggHorScrollVisible && contentHeight > this.clientHeight - 15) || (!me._text_scroll_reading_3.ggHorScrollVisible && contentHeight > this.clientHeight)) {
					me._text_scroll_reading_3__vertScrollBg.style.visibility = 'inherit';
					me._text_scroll_reading_3__vertScrollFg.style.visibility = 'inherit';
					me._text_scroll_reading_3.ggVertScrollVisible = true;
					if (!me._text_scroll_reading_3.ggHorScrollVisible && (contentWidth > offsetWidthWithScale - me._text_scroll_reading_3__vertScrollBg.getBoundingClientRect().width)) {
						me._text_scroll_reading_3__horScrollBg.style.visibility = 'inherit';
						me._text_scroll_reading_3__horScrollFg.style.visibility = 'inherit';
						me._text_scroll_reading_3.ggHorScrollVisible = true;
					}
				} else {
					me._text_scroll_reading_3__vertScrollBg.style.visibility = 'hidden';
					me._text_scroll_reading_3__vertScrollFg.style.visibility = 'hidden';
					me._text_scroll_reading_3.ggVertScrollVisible = false;
				}
				if(me._text_scroll_reading_3.ggHorScrollVisible) {
					me._text_scroll_reading_3.ggAvailableHeight = me._text_scroll_reading_3.clientHeight - 15;
					if (me._text_scroll_reading_3.ggVertScrollVisible) {
						me._text_scroll_reading_3.ggAvailableWidth = me._text_scroll_reading_3.clientWidth - 15;
						me._text_scroll_reading_3.ggAvailableWidthWithScale = me._text_scroll_reading_3.getBoundingClientRect().width - me._text_scroll_reading_3__horScrollBg.getBoundingClientRect().height;
					} else {
						me._text_scroll_reading_3.ggAvailableWidth = me._text_scroll_reading_3.clientWidth;
						me._text_scroll_reading_3.ggAvailableWidthWithScale = me._text_scroll_reading_3.getBoundingClientRect().width;
					}
					me._text_scroll_reading_3__horScrollBg.style.width = me._text_scroll_reading_3.ggAvailableWidth + 'px';
					me._text_scroll_reading_3.ggHPercentVisible = contentWidth != 0 ? me._text_scroll_reading_3.ggAvailableWidthWithScale / contentWidth : 0.0;
					if (me._text_scroll_reading_3.ggHPercentVisible > 1.0) me._text_scroll_reading_3.ggHPercentVisible = 1.0;
					me._text_scroll_reading_3.ggScrollWidth = Math.round(me._text_scroll_reading_3__horScrollBg.offsetWidth * me._text_scroll_reading_3.ggHPercentVisible);
					me._text_scroll_reading_3__horScrollFg.style.width = me._text_scroll_reading_3.ggScrollWidth + 'px';
					me._text_scroll_reading_3.ggScrollPosX = me._text_scroll_reading_3.ggScrollPosXPercent * me._text_scroll_reading_3.ggAvailableWidth;
					me._text_scroll_reading_3.ggScrollPosX = Math.min(me._text_scroll_reading_3.ggScrollPosX, me._text_scroll_reading_3__horScrollBg.offsetWidth - me._text_scroll_reading_3__horScrollFg.offsetWidth);
					me._text_scroll_reading_3__horScrollFg.style.left = me._text_scroll_reading_3.ggScrollPosX + 'px';
					if (me._text_scroll_reading_3.ggHPercentVisible < 1.0) {
						let percentScrolled = me._text_scroll_reading_3.ggScrollPosX / (me._text_scroll_reading_3__horScrollBg.offsetWidth - me._text_scroll_reading_3__horScrollFg.offsetWidth);
						me._text_scroll_reading_3__content.style.left = -(Math.round((me._text_scroll_reading_3.ggContentWidth * (1.0 - me._text_scroll_reading_3.ggHPercentVisible)) * percentScrolled)) + this.ggContentLeftOffset + 'px';
					}
				} else {
					me._text_scroll_reading_3.ggAvailableHeight = me._text_scroll_reading_3.clientHeight;
					me._text_scroll_reading_3.ggScrollPosX = 0;
					me._text_scroll_reading_3.ggScrollPosXPercent = 0.0;
					me._text_scroll_reading_3__content.style.left = this.ggContentLeftOffset + 'px';
				}
				if(me._text_scroll_reading_3.ggVertScrollVisible) {
					me._text_scroll_reading_3.ggAvailableWidth = me._text_scroll_reading_3.clientWidth - 15;
					if (me._text_scroll_reading_3.ggHorScrollVisible) {
						me._text_scroll_reading_3.ggAvailableHeight = me._text_scroll_reading_3.clientHeight - 15;
						me._text_scroll_reading_3.ggAvailableHeightWithScale = me._text_scroll_reading_3.getBoundingClientRect().height - me._text_scroll_reading_3__vertScrollBg.getBoundingClientRect().width;
						me._text_scroll_reading_3__cornerBg.style.visibility = 'inherit';
					} else {
						me._text_scroll_reading_3.ggAvailableHeight = me._text_scroll_reading_3.clientHeight;
						me._text_scroll_reading_3.ggAvailableHeightWithScale = me._text_scroll_reading_3.getBoundingClientRect().height;
						me._text_scroll_reading_3__cornerBg.style.visibility = 'hidden';
					}
					me._text_scroll_reading_3__vertScrollBg.style.height = me._text_scroll_reading_3.ggAvailableHeight + 'px';
					me._text_scroll_reading_3.ggVPercentVisible = contentHeight != 0 ? me._text_scroll_reading_3.ggAvailableHeightWithScale / contentHeight : 0.0;
					if (me._text_scroll_reading_3.ggVPercentVisible > 1.0) me._text_scroll_reading_3.ggVPercentVisible = 1.0;
					me._text_scroll_reading_3.ggScrollHeight =  Math.round(me._text_scroll_reading_3__vertScrollBg.offsetHeight * me._text_scroll_reading_3.ggVPercentVisible);
					me._text_scroll_reading_3__vertScrollFg.style.height = me._text_scroll_reading_3.ggScrollHeight + 'px';
					me._text_scroll_reading_3.ggScrollPosY = me._text_scroll_reading_3.ggScrollPosYPercent * me._text_scroll_reading_3.ggAvailableHeight;
					me._text_scroll_reading_3.ggScrollPosY = Math.min(me._text_scroll_reading_3.ggScrollPosY, me._text_scroll_reading_3__vertScrollBg.offsetHeight - me._text_scroll_reading_3__vertScrollFg.offsetHeight);
					me._text_scroll_reading_3__vertScrollFg.style.top = me._text_scroll_reading_3.ggScrollPosY + 'px';
					if (me._text_scroll_reading_3.ggVPercentVisible < 1.0) {
						let percentScrolled = me._text_scroll_reading_3.ggScrollPosY / (me._text_scroll_reading_3__vertScrollBg.offsetHeight - me._text_scroll_reading_3__vertScrollFg.offsetHeight);
						me._text_scroll_reading_3__content.style.top = -(Math.round((me._text_scroll_reading_3.ggContentHeight * (1.0 - me._text_scroll_reading_3.ggVPercentVisible)) * percentScrolled)) + me._text_scroll_reading_3.ggContentTopOffset + 'px';
					}
				} else {
					...
					me._text_scroll_reading_3.ggScrollPosY = 0;
					me._text_scroll_reading_3.ggScrollPosYPercent = 0.0;
					me._text_scroll_reading_3__content.style.top = this.ggContentTopOffset + 'px';
					me._text_scroll_reading_3__cornerBg.style.visibility = 'hidden';
				}
				if(horScrollWasVisible != me._text_scroll_reading_3.ggHorScrollVisible || vertScrollWasVisible != me._text_scroll_reading_3.ggVertScrollVisible) {
					skin.updateSize(me._text_scroll_reading_3);
					me._text_scroll_reading_3.ggUpdatePosition();
				}
			}
		}
		el=me._text_info_reading_3=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._text_info_reading_3;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		els=me._text_info_reading_3__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="text_info_reading_3";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_text ";
		el.ggType='text';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._text_info_reading_3.ggUpdateText=function() {
			var params = [];
			var hs = player._("<div class=\"ggmarkdown\"><h1>\u042d\u0442\u043e \u043c\u0435\u043c\u043e\u0440\u0438\u0430\u043b\u044c\u043d\u044b\u0439 \u0437\u0430\u043b \u043f\u0430\u0440\u0430\u0434\u043d\u043e\u0439 \u0430\u043d\u0444\u0438\u043b\u0430\u0434\u044b \u0411\u043e\u043b\u044c\u0448\u043e\u0433\u043e \u041f\u0435\u0442\u0435\u0440\u0433\u043e\u0444\u0441\u043a\u043e\u0433\u043e \u0434\u0432\u043e\u0440\u0446\u0430.<\/h1>\n<p>\u041e\u043d \u0431\u044b\u043b \u043e\u0444\u043e\u0440\u043c\u043b\u0435\u043d \u043f\u0440\u0438 \u0415\u043a\u0430\u0442\u0435\u0440\u0438\u043d\u0435 II \u0432 \u043f\u0430\u043c\u044f\u0442\u044c \u043e \u043f\u043e\u0431\u0435\u0434\u0435 \u0440\u0443\u0441\u0441\u043a\u043e\u0433\u043e \u0444\u043b\u043e\u0442\u0430 \u0432 \u0427\u0435\u0441\u043c\u0435\u043d\u0441\u043a\u043e\u043c\n\u0441\u0440\u0430\u0436\u0435\u043d\u0438\u0438. \u0413\u043b\u0430\u0432\u043d\u044b\u043c \u0445\u0443\u0434\u043e\u0436\u0435\u0441\u0442\u0432\u0435\u043d\u043d\u044b\u043c \u0430\u043a\u0446\u0435\u043d\u0442\u043e\u043c \u0437\u0430\u043b\u0430 \u0441\u0442\u0430\u043b\u0438 \u0434\u0432\u0435\u043d\u0430\u0434\u0446\u0430\u0442\u044c \u043f\u043e\u043b\u043e\u0442\u0435\u043d \u042f\u043a\u043e\u0431\u0430\n\u0424\u0438\u043b\u0438\u043f\u043f\u0430 \u0425\u0430\u043a\u043a\u0435\u0440\u0442\u0430, \u043f\u043e\u0441\u0432\u044f\u0449\u0435\u043d\u043d\u044b\u0445 \u0410\u0440\u0445\u0438\u043f\u0435\u043b\u0430\u0433\u0441\u043a\u043e\u0439 \u044d\u043a\u0441\u043f\u0435\u0434\u0438\u0446\u0438\u0438 \u0438 \u043c\u043e\u0440\u0441\u043a\u0438\u043c \u043f\u043e\u0431\u0435\u0434\u0430\u043c\n\u0440\u0443\u0441\u0441\u043a\u043e\u0433\u043e \u0444\u043b\u043e\u0442\u0430. \u0414\u043b\u044f \u043f\u0430\u043d\u043e\u0440\u0430\u043c\u044b \u044d\u0442\u043e\u0442 \u043a\u0430\u0434\u0440 \u043c\u043e\u0436\u043d\u043e \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u044c \u043a\u0430\u043a \u043e\u0431\u0449\u0438\u0439 \u043a\u043e\u043d\u0442\u0435\u043a\u0441\u0442:\n\u0438\u043c\u0435\u043d\u043d\u043e \u0437\u0434\u0435\u0441\u044c \u0436\u0438\u0432\u043e\u043f\u0438\u0441\u044c, \u0430\u0440\u0445\u0438\u0442\u0435\u043a\u0442\u0443\u0440\u0430 \u0438 \u0438\u0441\u0442\u043e\u0440\u0438\u0447\u0435\u0441\u043a\u0430\u044f \u043f\u0430\u043c\u044f\u0442\u044c \u043e\u0431\u044a\u0435\u0434\u0438\u043d\u0435\u043d\u044b \u0432 \u0435\u0434\u0438\u043d\u0443\u044e\n\u044d\u043a\u0441\u043f\u043e\u0437\u0438\u0446\u0438\u044e \u043e \u0427\u0435\u0441\u043c\u0435.<\/p>\n<p>\u0441\u0432\u0435\u0442\u043b\u044b\u0435 \u0441\u0442\u0435\u043d\u044b \u0438 \u0441\u0442\u043e\u043b \u0441 \u0441\u0435\u0440\u0432\u0438\u0440\u043e\u0432\u043a\u043e\u0439. \u0414\u043b\u044f \u043f\u0430\u043d\u043e\u0440\u0430\u043c\u044b \u044d\u0442\u043e\n\u0438\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435 \u043c\u043e\u0436\u043d\u043e \u043e\u0431\u043e\u0437\u043d\u0430\u0447\u0438\u0442\u044c \u043a\u0430\u043a \xab\u0438\u043d\u0442\u0435\u0440\u044c\u0435\u0440 \u041f\u0435\u0442\u0440\u043e\u0434\u0432\u043e\u0440\u0446\u0430\xbb \u0438\u043b\u0438 \xab\u043e\u0434\u0438\u043d \u0438\u0437 \u0437\u0430\u043b\u043e\u0432\n\u0434\u0432\u043e\u0440\u0446\u043e\u0432\u043e\u0433\u043e \u043a\u043e\u043c\u043f\u043b\u0435\u043a\u0441\u0430 \u041f\u0435\u0442\u0435\u0440\u0433\u043e\u0444\u0430\xbb. \u041f\u0435\u0442\u0435\u0440\u0433\u043e\u0444 \u0431\u044b\u043b \u0437\u0430\u0434\u0443\u043c\u0430\u043d \u043a\u0430\u043a \u043f\u0430\u0440\u0430\u0434\u043d\u0430\u044f\n\u0438\u043c\u043f\u0435\u0440\u0430\u0442\u043e\u0440\u0441\u043a\u0430\u044f \u0440\u0435\u0437\u0438\u0434\u0435\u043d\u0446\u0438\u044f \u0443 \u0424\u0438\u043d\u0441\u043a\u043e\u0433\u043e \u0437\u0430\u043b\u0438\u0432\u0430. \u0415\u0433\u043e \u0434\u0432\u043e\u0440\u0446\u043e\u0432\u044b\u0435 \u0437\u0430\u043b\u044b \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043b\u0438\u0441\u044c\n\u0434\u043b\u044f \u0446\u0435\u0440\u0435\u043c\u043e\u043d\u0438\u0439, \u043f\u0440\u0438\u0435\u043c\u043e\u0432 \u0438 \u0434\u0435\u043c\u043e\u043d\u0441\u0442\u0440\u0430\u0446\u0438\u0438 \u0441\u0442\u0430\u0442\u0443\u0441\u0430 \u0420\u043e\u0441\u0441\u0438\u0439\u0441\u043a\u043e\u0439 \u0438\u043c\u043f\u0435\u0440\u0438\u0438. \u0415\u0441\u043b\u0438 \u043d\u0443\u0436\u043d\u0430\n\u0430\u0431\u0441\u043e\u043b\u044e\u0442\u043d\u043e \u0442\u043e\u0447\u043d\u0430\u044f \u043f\u043e\u0434\u043f\u0438\u0441\u044c, \u043b\u0443\u0447\u0448\u0435 \u0441\u0432\u0435\u0440\u0438\u0442\u044c \u0444\u043e\u0442\u043e \u0441 \u043c\u0443\u0437\u0435\u0439\u043d\u044b\u043c \u043f\u043b\u0430\u043d\u043e\u043c \u0438\u043b\u0438 \u044d\u043a\u0441\u043f\u043b\u0438\u043a\u0430\u0446\u0438\u0435\u0439\n\u043a\u043e\u043d\u043a\u0440\u0435\u0442\u043d\u043e\u0433\u043e \u0437\u0430\u043b\u0430.<\/p>\n<div>", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_info_reading_3.ggUpdateText();
		el.appendChild(els);
		me._text_info_reading_3.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._text_info_reading_3.ggUpdatePosition=function (useTransition) {
		}
		me._text_scroll_reading_3__content.appendChild(me._text_info_reading_3);
		me._rectangle_3.appendChild(me._text_scroll_reading_3);
		el=me._popup_image_reading_2_3=document.createElement('div');
		els=me._popup_image_reading_2_3__img=document.createElement('img');
		els.className='ggskin ggskin_popup_image_reading_2_3';
		hs=basePath + 'images/popup_image_reading_2_3.jpg';
		...
		el.appendChild(els);
		el.ggSubElement = els;
		el.ggId="popup_image_reading_2_3";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._popup_image_reading_2_3.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._popup_image_reading_2_3.ggUpdatePosition=function (useTransition) {
		}
		me._rectangle_3.appendChild(me._popup_image_reading_2_3);
		me._info_popup_3galery.appendChild(me._rectangle_3);
		me.divSkin.appendChild(me._info_popup_3galery);
		el=me._info_popup_2galery=document.createElement('div');
		el.ggId="info_popup_2Galery";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		el.ggType='container';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._info_popup_2galery.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._info_popup_2galery.ggUpdatePosition=function (useTransition) {
		}
		...
		el=me._btn_close_reading_2=document.createElement('div');
		els=me._btn_close_reading_2__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="btn_close_reading_2";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_text ";
		el.ggType='text';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._btn_close_reading_2.ggUpdateText=function() {
			var params = [];
			var hs = player._("X", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
		...
		me._btn_close_reading_2.ggUpdateText();
		el.appendChild(els);
		me._btn_close_reading_2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._btn_close_reading_2.onclick=function (e) {
			if (player.transitionsDisabled) {
				me._info_popup_2galery.style.transition='none';
			} else {
				me._info_popup_2galery.style.transition='all 400ms ease-out 0ms';
			}
			me._info_popup_2galery.ggParameter.rx=0;me._info_popup_2galery.ggParameter.ry=0;
			me._info_popup_2galery.style.transform=parameterToTransform(me._info_popup_2galery.ggParameter);
		}
		me._btn_close_reading_2.ggUpdatePosition=function (useTransition) {
		}
		me._rectangle_2.appendChild(me._btn_close_reading_2);
		el=me._popup_image_reading_2_2=document.createElement('div');
		els=me._popup_image_reading_2_2__img=document.createElement('img');
		els.className='ggskin ggskin_popup_image_reading_2_2';
		hs=basePath + 'images/popup_image_reading_2_2.jpg';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		...
		el.appendChild(els);
		el.ggSubElement = els;
		el.ggId="popup_image_reading_2_2";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_image ";
		el.ggType='image';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._popup_image_reading_2_2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._popup_image_reading_2_2.ggUpdatePosition=function (useTransition) {
		}
		me._rectangle_2.appendChild(me._popup_image_reading_2_2);
		el=me._popup_image_reading_2_1=document.createElement('div');
		els=me._popup_image_reading_2_1__img=document.createElement('img');
		els.className='ggskin ggskin_popup_image_reading_2_1';
		hs=basePath + 'images/popup_image_reading_2_1.jpg';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		...
		el.appendChild(els);
		el.ggSubElement = els;
		el.ggId="popup_image_reading_2_1";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_image ";
		el.ggType='image';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._popup_image_reading_2_1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._popup_image_reading_2_1.ggUpdatePosition=function (useTransition) {
		}
		me._rectangle_2.appendChild(me._popup_image_reading_2_1);
		el=me._text_scroll_reading_2=document.createElement('div');
		els=me._text_scroll_reading_2__content=document.createElement('div');
		els.className='ggskin ggskin_subelement ggskin_scrollarea';
		el.ggContent=els;
		el.appendChild(els);
		el.ggHorScrollVisible = false;
		...
		hs+="";
		els.setAttribute('style',hs);
		me._text_scroll_reading_2.ggScrollByX = function(diffX) {
			if(!me._text_scroll_reading_2.ggHorScrollVisible || diffX == 0 || me._text_scroll_reading_2.ggHPercentVisible >= 1.0) return;
			me._text_scroll_reading_2.ggScrollPosX = (me._text_scroll_reading_2__horScrollFg.offsetLeft + diffX);
			me._text_scroll_reading_2.ggScrollPosX = Math.max(me._text_scroll_reading_2.ggScrollPosX, 0);
			me._text_scroll_reading_2.ggScrollPosX = Math.min(me._text_scroll_reading_2.ggScrollPosX, me._text_scroll_reading_2__horScrollBg.offsetWidth - me._text_scroll_reading_2__horScrollFg.offsetWidth);
			me._text_scroll_reading_2__horScrollFg.style.left = me._text_scroll_reading_2.ggScrollPosX + 'px';
			let percentScrolled = me._text_scroll_reading_2.ggScrollPosX / (me._text_scroll_reading_2__horScrollBg.offsetWidth - me._text_scroll_reading_2__horScrollFg.offsetWidth);
			me._text_scroll_reading_2__content.style.left = -(Math.round((me._text_scroll_reading_2.ggContentWidth * (1.0 - me._text_scroll_reading_2.ggHPercentVisible)) * percentScrolled)) + me._text_scroll_reading_2.ggContentLeftOffset + 'px';
			me._text_scroll_reading_2.ggScrollPosXPercent = (me._text_scroll_reading_2__horScrollFg.offsetLeft / me._text_scroll_reading_2__horScrollBg.offsetWidth);
		}
		me._text_scroll_reading_2.ggScrollByXSmooth = function(diffX) {
			if(!me._text_scroll_reading_2.ggHorScrollVisible || diffX == 0 || me._text_scroll_reading_2.ggHPercentVisible >= 1.0) return;
			var scrollPerInterval = diffX / 25;
			var scrollCurrX = 0;
			var id = setInterval(function() {
				scrollCurrX += scrollPerInterval;
				me._text_scroll_reading_2.ggScrollPosX += scrollPerInterval;
				if (diffX > 0 && (scrollCurrX >= diffX || me._text_scroll_reading_2.ggScrollPosX >= me._text_scroll_reading_2__horScrollBg.offsetWidth - me._text_scroll_reading_2__horScrollFg.offsetWidth)) {
					me._text_scroll_reading_2.ggScrollPosX = Math.min(me._text_scroll_reading_2.ggScrollPosX, me._text_scroll_reading_2__horScrollBg.offsetWidth - me._text_scroll_reading_2__horScrollFg.offsetWidth);
					clearInterval(id);
				}
				if (diffX < 0 && (scrollCurrX <= diffX || me._text_scroll_reading_2.ggScrollPosX <= 0)) {
					me._text_scroll_reading_2.ggScrollPosX = Math.max(me._text_scroll_reading_2.ggScrollPosX, 0);
					clearInterval(id);
				}
			me._text_scroll_reading_2__horScrollFg.style.left = me._text_scroll_reading_2.ggScrollPosX + 'px';
		...
		me._text_scroll_reading_2.ggScrollByY = function(diffY) {
			if(!me._text_scroll_reading_2.ggVertScrollVisible || diffY == 0 || me._text_scroll_reading_2.ggVPercentVisible >= 1.0) return;
			me._text_scroll_reading_2.ggScrollPosY = (me._text_scroll_reading_2__vertScrollFg.offsetTop + diffY);
			me._text_scroll_reading_2.ggScrollPosY = Math.max(me._text_scroll_reading_2.ggScrollPosY, 0);
			me._text_scroll_reading_2.ggScrollPosY = Math.min(me._text_scroll_reading_2.ggScrollPosY, me._text_scroll_reading_2__vertScrollBg.offsetHeight - me._text_scroll_reading_2__vertScrollFg.offsetHeight);
			me._text_scroll_reading_2__vertScrollFg.style.top = me._text_scroll_reading_2.ggScrollPosY + 'px';
			let percentScrolled = me._text_scroll_reading_2.ggScrollPosY / (me._text_scroll_reading_2__vertScrollBg.offsetHeight - me._text_scroll_reading_2__vertScrollFg.offsetHeight);
			me._text_scroll_reading_2__content.style.top = -(Math.round((me._text_scroll_reading_2.ggContentHeight * (1.0 - me._text_scroll_reading_2.ggVPercentVisible)) * percentScrolled)) + me._text_scroll_reading_2.ggContentTopOffset + 'px';
			me._text_scroll_reading_2.ggScrollPosYPercent = (me._text_scroll_reading_2__vertScrollFg.offsetTop / me._text_scroll_reading_2__vertScrollBg.offsetHeight);
		}
		me._text_scroll_reading_2.ggScrollByYSmooth = function(diffY) {
			if(!me._text_scroll_reading_2.ggVertScrollVisible || diffY == 0 || me._text_scroll_reading_2.ggVPercentVisible >= 1.0) return;
			var scrollPerInterval = diffY / 25;
			var scrollCurrY = 0;
			var id = setInterval(function() {
				scrollCurrY += scrollPerInterval;
				me._text_scroll_reading_2.ggScrollPosY += scrollPerInterval;
				if (diffY > 0 && (scrollCurrY >= diffY || me._text_scroll_reading_2.ggScrollPosY >= me._text_scroll_reading_2__vertScrollBg.offsetHeight - me._text_scroll_reading_2__vertScrollFg.offsetHeight)) {
					me._text_scroll_reading_2.ggScrollPosY = Math.min(me._text_scroll_reading_2.ggScrollPosY, me._text_scroll_reading_2__vertScrollBg.offsetHeight - me._text_scroll_reading_2__vertScrollFg.offsetHeight);
					clearInterval(id);
				}
				if (diffY < 0 && (scrollCurrY <= diffY || me._text_scroll_reading_2.ggScrollPosY <= 0)) {
					me._text_scroll_reading_2.ggScrollPosY = Math.max(me._text_scroll_reading_2.ggScrollPosY, 0);
					clearInterval(id);
				}
			me._text_scroll_reading_2__vertScrollFg.style.top = me._text_scroll_reading_2.ggScrollPosY + 'px';
		...
		me._text_scroll_reading_2.ggScrollIntoView = function(posX, posY, width, height) {
			if (me._text_scroll_reading_2.ggHorScrollVisible) {
				if (posX < 0) {
					var diffX = Math.floor(posX * me._text_scroll_reading_2.ggHPercentVisible);
					me._text_scroll_reading_2.ggScrollByXSmooth(diffX);
				} else if (posX + width > me._text_scroll_reading_2.clientWidth - (me._text_scroll_reading_2.ggVertScrollVisible ? 15 : 0)) {
					var diffX = Math.ceil(((posX + width) - (me._text_scroll_reading_2.clientWidth - (me._text_scroll_reading_2.ggVertScrollVisible ? 15 : 0))) * me._text_scroll_reading_2.ggHPercentVisible);
					me._text_scroll_reading_2.ggScrollByXSmooth(diffX);
				}
			}
			if (me._text_scroll_reading_2.ggVertScrollVisible) {
				if (posY < 0) {
					var diffY = Math.floor(posY * me._text_scroll_reading_2.ggVPercentVisible);
					me._text_scroll_reading_2.ggScrollByYSmooth(diffY);
				} else if (posY + height > me._text_scroll_reading_2.clientHeight - (me._text_scroll_reading_2.ggHorScrollVisible ? 15 : 0)) {
					var diffY = Math.ceil(((posY + height) - (me._text_scroll_reading_2.clientHeight - (me._text_scroll_reading_2.ggHorScrollVisible ? 15 : 0))) * me._text_scroll_reading_2.ggVPercentVisible);
					me._text_scroll_reading_2.ggScrollByYSmooth(diffY);
				}
			}
		}
		me._text_scroll_reading_2__content.mousetouchend = e => {
			let inertiaInterval = setInterval(function() {
				me._text_scroll_reading_2.ggDragInertiaX *= 0.96;
				me._text_scroll_reading_2.ggDragInertiaY *= 0.96;
				me._text_scroll_reading_2.ggScrollByX(me._text_scroll_reading_2.ggDragInertiaX);
				me._text_scroll_reading_2.ggScrollByY(me._text_scroll_reading_2.ggDragInertiaY);
				if (Math.abs(me._text_scroll_reading_2.ggDragInertiaX) < 1.0 && Math.abs(me._text_scroll_reading_2.ggDragInertiaY) < 1.0) {
					clearInterval(inertiaInterval);
				}
				}, 10);
			me._text_scroll_reading_2__content.onmouseup = null;
			me._text_scroll_reading_2__content.onmousemove = null;
			me._text_scroll_reading_2__content.ontouchend = null;
			me._text_scroll_reading_2__content.ontouchmove = null;
			me._text_scroll_reading_2__content.onpointerup = null;
			me._text_scroll_reading_2__content.onpointermove = null;
			setTimeout(function() { me._text_scroll_reading_2.ggIsDragging = false; }, 100);
		}
		me._text_scroll_reading_2__content.mousetouchmove = e => {
			e = e || window.event;
			e.preventDefault();
			var t = e.touches;
			var eventX = t ? t[0].clientX : e.clientX;
			var eventY = t ? t[0].clientY : e.clientY;
			if (Math.abs(eventX - me._text_scroll_reading_2.ggDragStartX) > 10 || Math.abs(eventY - me._text_scroll_reading_2.ggDragStartY) > 10) me._text_scroll_reading_2.ggIsDragging = true;
			var diffX = (eventX - me._text_scroll_reading_2.ggDragLastX) * me._text_scroll_reading_2.ggHPercentVisible;
			var diffY = (eventY - me._text_scroll_reading_2.ggDragLastY) * me._text_scroll_reading_2.ggVPercentVisible;
			me._text_scroll_reading_2.ggDragInertiaX = -diffX;
			me._text_scroll_reading_2.ggDragInertiaY = -diffY;
			me._text_scroll_reading_2.ggDragLastX = eventX;
			me._text_scroll_reading_2.ggDragLastY = eventY;
			me._text_scroll_reading_2.ggScrollByX(-diffX);
			me._text_scroll_reading_2.ggScrollByY(-diffY);
		}
		me._text_scroll_reading_2__content.mousetouchstart = e => {
			e = e || window.event;
			var t = e.touches;
			me._text_scroll_reading_2.ggDragLastX = me._text_scroll_reading_2.ggDragStartX = t ? t[0].clientX : e.clientX;
			me._text_scroll_reading_2.ggDragLastY = me._text_scroll_reading_2.ggDragStartY = t ? t[0].clientY : e.clientY;
			me._text_scroll_reading_2__content.onmouseup = me._text_scroll_reading_2__content.mousetouchend;
			me._text_scroll_reading_2__content.ontouchend = me._text_scroll_reading_2__content.mousetouchend;
			me._text_scroll_reading_2__content.onmousemove = me._text_scroll_reading_2__content.mousetouchmove;
			me._text_scroll_reading_2__content.ontouchmove = me._text_scroll_reading_2__content.mousetouchmove;
			if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
				me._text_scroll_reading_2__content.onpointerup = me._text_scroll_reading_2__content.ontouchend;
				me._text_scroll_reading_2__content.onpointermove = me._text_scroll_reading_2__content.ontouchmove;
			}
		}
		els.onmousedown = me._text_scroll_reading_2__content.mousetouchstart;
		els.ontouchstart = me._text_scroll_reading_2__content.mousetouchstart;
		if (player.getOS() == 1 && navigator.maxTouchPoints > 0) {
			els.onpointerdown = me._text_scroll_reading_2__content.mousetouchstart;
		}
		elHorScrollBg = me._text_scroll_reading_2__horScrollBg = document.createElement('div');
		el.appendChild(elHorScrollBg);
		elHorScrollBg.setAttribute('style', 'position: absolute; left: 0px; bottom: 0px; visibility: hidden; width: 603px; height: 15px; background-color: rgba(128,128,128,1); pointer-events: auto;');
		elHorScrollBg.className='ggskin ggskin_scrollarea_hscrollbg';
		elHorScrollFg = me._text_scroll_reading_2__horScrollFg = document.createElement('div');
		elHorScrollBg.appendChild(elHorScrollFg);
		elHorScrollFg.className='ggskin ggskin_scrollarea_hscrollfg';
		elHorScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 603px; height: 15px; background-color: rgba(192,192,192,1); pointer-events: auto;');
		me._text_scroll_reading_2.ggScrollPosX = 0;
		me._text_scroll_reading_2.ggScrollPosXPercent = 0.0;
		elHorScrollFg.onmousedown = function(e) {
			if (player.getOS() == 1 && navigator.maxTouchPoints > 0) return;
			e = e || window.event;
			e.preventDefault();
			e.stopPropagation();
			me._text_scroll_reading_2.ggDragLastX = e.clientX;
			document.onmouseup = function() {
				let inertiaInterval = setInterval(function() {
					me._text_scroll_reading_2.ggDragInertiaX *= 0.96;
					me._text_scroll_reading_2.ggScrollByX(me._text_scroll_reading_2.ggDragInertiaX);
					if (Math.abs(me._text_scroll_reading_2.ggDragInertiaX) < 1.0) {
						clearInterval(inertiaInterval);
					}
					}, 10);
				document.onmouseup = null;
			...
			document.onmousemove = function(e) {
				e = e || window.event;
				e.preventDefault();
				var diffX = e.clientX - me._text_scroll_reading_2.ggDragLastX;
				me._text_scroll_reading_2.ggDragInertiaX = diffX;
				me._text_scroll_reading_2.ggDragLastX = e.clientX;
				me._text_scroll_reading_2.ggScrollByX(diffX);
			}
		...
		elHorScrollFg.ontouchstart = function(e) {
			...
			e.stopPropagation();
			var t = e.touches;
			me._text_scroll_reading_2.ggDragLastX = t ? t[0].clientX : e.clientX;
			document.ontouchend = function() {
				let inertiaInterval = setInterval(function() {
					me._text_scroll_reading_2.ggDragInertiaX *= 0.96;
					me._text_scroll_reading_2.ggScrollByX(me._text_scroll_reading_2.ggDragInertiaX);
			...
			document.ontouchmove = function(e) {
				...
				e.preventDefault();
				var t = e.touches;
				var diffX = (t ? t[0].clientX : e.clientX) - me._text_scroll_reading_2.ggDragLastX;
				me._text_scroll_reading_2.ggDragInertiaX = diffX;
				me._text_scroll_reading_2.ggDragLastX = t ? t[0].clientX : e.clientX;
				me._text_scroll_reading_2.ggScrollByX(diffX);
			}
		...
		elHorScrollBg.onmousedown = function(e) {
			e = e || window.event;
			e.preventDefault();
			var diffX = me._text_scroll_reading_2.ggScrollWidth;
			if (e.offsetX < me._text_scroll_reading_2.ggScrollPosX) {
				diffX = diffX * -1;
			}
			me._text_scroll_reading_2.ggScrollByXSmooth(diffX);
		}
		elHorScrollBg.ontouchstart = function(e) {
			...
			e.stopPropagation();
			var t = e.touches;
			var rect = me._text_scroll_reading_2__horScrollBg.getBoundingClientRect();
			var diffX = me._text_scroll_reading_2.ggScrollWidth;
			if ((t[0].clientX - rect.left) < me._text_scroll_reading_2.ggScrollPosX) {
				diffX = diffX * -1;
			}
			me._text_scroll_reading_2.ggScrollByXSmooth(diffX);
		}
		el.addEventListener('wheel', function(e) {
			e.preventDefault();
			var wheelDelta = Math.sign(e.deltaX);
			me._text_scroll_reading_2.ggScrollByXSmooth(30 * me._text_scroll_reading_2.ggHPercentVisible * wheelDelta);
		});
		elVertScrollBg = me._text_scroll_reading_2__vertScrollBg = document.createElement('div');
		el.appendChild(elVertScrollBg);
		elVertScrollBg.setAttribute('style', 'position: absolute; right: 0px; top: 0px; visibility: hidden; width: 15px; height: 238px; background-color: rgba(128,128,128,1); pointer-events: auto;');
		elVertScrollBg.className='ggskin ggskin_scrollarea_vscrollbg';
		elVertScrollFg = me._text_scroll_reading_2__vertScrollFg = document.createElement('div');
		elVertScrollBg.appendChild(elVertScrollFg);
		elVertScrollFg.setAttribute('style', 'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 15px; height: 238px; background-color: rgba(192,192,192,1); pointer-events: auto;');
		elVertScrollFg.className='ggskin ggskin_scrollarea_vscrollfg';
		me._text_scroll_reading_2.ggScrollPosY = 0;
		me._text_scroll_reading_2.ggScrollPosYPercent = 0.0;
		elVertScrollFg.onmousedown = function(e) {
			if (player.getOS() == 1 && navigator.maxTouchPoints > 0) return;
			e = e || window.event;
			e.preventDefault();
			e.stopPropagation();
			me._text_scroll_reading_2.ggDragLastY = e.clientY;
			document.onmouseup = function() {
				let inertiaInterval = setInterval(function() {
					me._text_scroll_reading_2.ggDragInertiaY *= 0.96;
					me._text_scroll_reading_2.ggScrollByY(me._text_scroll_reading_2.ggDragInertiaY);
					if (Math.abs(me._text_scroll_reading_2.ggDragInertiaY) < 1.0) {
						clearInterval(inertiaInterval);
					}
					}, 10);
				document.onmouseup = null;
			...
			document.onmousemove = function(e) {
				e = e || window.event;
				e.preventDefault();
				var diffY = e.clientY - me._text_scroll_reading_2.ggDragLastY;
				me._text_scroll_reading_2.ggDragInertiaY = diffY;
				me._text_scroll_reading_2.ggDragLastY = e.clientY;
				me._text_scroll_reading_2.ggScrollByY(diffY);
			}
		...
		elVertScrollFg.ontouchstart = function(e) {
			...
			e.stopPropagation();
			var t = e.touches;
			me._text_scroll_reading_2.ggDragLastY = t ? t[0].clientY : e.clientY;
			document.ontouchend = function() {
				let inertiaInterval = setInterval(function() {
					me._text_scroll_reading_2.ggDragInertiaY *= 0.96;
					me._text_scroll_reading_2.ggScrollByY(me._text_scroll_reading_2.ggDragInertiaY);
			...
			document.ontouchmove = function(e) {
				...
				e.preventDefault();
				var t = e.touches;
				var diffY = (t ? t[0].clientY : e.clientY) - me._text_scroll_reading_2.ggDragLastY;
				me._text_scroll_reading_2.ggDragInertiaY = diffY;
				me._text_scroll_reading_2.ggDragLastY = t ? t[0].clientY : e.clientY;
				me._text_scroll_reading_2.ggScrollByY(diffY);
			}
		...
		elVertScrollBg.onmousedown = function(e) {
			e = e || window.event;
			e.preventDefault();
			var diffY = me._text_scroll_reading_2.ggScrollHeight;
			if (e.offsetY < me._text_scroll_reading_2.ggScrollPosY) {
				diffY = diffY * -1;
			}
			me._text_scroll_reading_2.ggScrollByYSmooth(diffY);
		}
		elVertScrollBg.ontouchstart = function(e) {
			...
			e.stopPropagation();
			var t = e.touches;
			var rect = me._text_scroll_reading_2__vertScrollBg.getBoundingClientRect();
			var diffY = me._text_scroll_reading_2.ggScrollHeight;
			if ((t[0].clientY - rect.top) < me._text_scroll_reading_2.ggScrollPosY) {
				diffY = diffY * -1;
			}
			me._text_scroll_reading_2.ggScrollByYSmooth(diffY);
		}
		el.addEventListener('wheel', function(e) {
			e.preventDefault();
			var wheelDelta = Math.sign(e.deltaY);
			me._text_scroll_reading_2.ggScrollByYSmooth(30 * me._text_scroll_reading_2.ggVPercentVisible * wheelDelta);
		});
		elCornerBg = me._text_scroll_reading_2__cornerBg = document.createElement('div');
		el.appendChild(elCornerBg);
		elCornerBg.setAttribute('style', 'position: absolute; right: 0px; bottom: 0px; visibility: hidden; width: 15px; height: 15px; background-color: rgba(255,255,255,1);');
		elCornerBg.className='ggskin ggskin_scrollarea_scrollcorner';
		el.ggId="text_scroll_reading_2";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_scrollarea ";
		el.ggType='scrollarea';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._text_scroll_reading_2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._text_scroll_reading_2.ggUpdatePosition=function (useTransition) {
			{
				var horScrollWasVisible = this.ggHorScrollVisible;
				var vertScrollWasVisible = this.ggVertScrollVisible;
				this.ggContent.style.left = '0px';
			...
			var scaleY = this.getBoundingClientRect().height / this.offsetHeight;
				this.ggContentHeight = contentHeight / scaleY;
				this.ggContent.style.left = -(Math.round(me._text_scroll_reading_2.ggScrollPosX / me._text_scroll_reading_2.ggHPercentVisible)) + this.ggContentLeftOffset + 'px';
				this.ggContent.style.marginLeft = '0px';
				this.ggContent.style.top = -(Math.round(me._text_scroll_reading_2.ggScrollPosY / me._text_scroll_reading_2.ggVPercentVisible)) + this.ggContentTopOffset + 'px';
				this.ggContent.style.marginTop = '0px';
				if (contentWidth > Math.ceil(offsetWidthWithScale)) {
					me._text_scroll_reading_2__horScrollBg.style.visibility = 'inherit';
					me._text_scroll_reading_2__horScrollFg.style.visibility = 'inherit';
					me._text_scroll_reading_2.ggHorScrollVisible = true;
				} else {
					me._text_scroll_reading_2__horScrollBg.style.visibility = 'hidden';
					me._text_scroll_reading_2__horScrollFg.style.visibility = 'hidden';
					me._text_scroll_reading_2.ggHorScrollVisible = false;
				}
				if ((me._text_scroll_reading_2.ggHorScrollVisible && contentHeight > this.clientHeight - 15) || (!me._text_scroll_reading_2.ggHorScrollVisible && contentHeight > this.clientHeight)) {
					me._text_scroll_reading_2__vertScrollBg.style.visibility = 'inherit';
					me._text_scroll_reading_2__vertScrollFg.style.visibility = 'inherit';
					me._text_scroll_reading_2.ggVertScrollVisible = true;
					if (!me._text_scroll_reading_2.ggHorScrollVisible && (contentWidth > offsetWidthWithScale - me._text_scroll_reading_2__vertScrollBg.getBoundingClientRect().width)) {
						me._text_scroll_reading_2__horScrollBg.style.visibility = 'inherit';
						me._text_scroll_reading_2__horScrollFg.style.visibility = 'inherit';
						me._text_scroll_reading_2.ggHorScrollVisible = true;
					}
				} else {
					me._text_scroll_reading_2__vertScrollBg.style.visibility = 'hidden';
					me._text_scroll_reading_2__vertScrollFg.style.visibility = 'hidden';
					me._text_scroll_reading_2.ggVertScrollVisible = false;
				}
				if(me._text_scroll_reading_2.ggHorScrollVisible) {
					me._text_scroll_reading_2.ggAvailableHeight = me._text_scroll_reading_2.clientHeight - 15;
					if (me._text_scroll_reading_2.ggVertScrollVisible) {
						me._text_scroll_reading_2.ggAvailableWidth = me._text_scroll_reading_2.clientWidth - 15;
						me._text_scroll_reading_2.ggAvailableWidthWithScale = me._text_scroll_reading_2.getBoundingClientRect().width - me._text_scroll_reading_2__horScrollBg.getBoundingClientRect().height;
					} else {
						me._text_scroll_reading_2.ggAvailableWidth = me._text_scroll_reading_2.clientWidth;
						me._text_scroll_reading_2.ggAvailableWidthWithScale = me._text_scroll_reading_2.getBoundingClientRect().width;
					}
					me._text_scroll_reading_2__horScrollBg.style.width = me._text_scroll_reading_2.ggAvailableWidth + 'px';
					me._text_scroll_reading_2.ggHPercentVisible = contentWidth != 0 ? me._text_scroll_reading_2.ggAvailableWidthWithScale / contentWidth : 0.0;
					if (me._text_scroll_reading_2.ggHPercentVisible > 1.0) me._text_scroll_reading_2.ggHPercentVisible = 1.0;
					me._text_scroll_reading_2.ggScrollWidth = Math.round(me._text_scroll_reading_2__horScrollBg.offsetWidth * me._text_scroll_reading_2.ggHPercentVisible);
					me._text_scroll_reading_2__horScrollFg.style.width = me._text_scroll_reading_2.ggScrollWidth + 'px';
					me._text_scroll_reading_2.ggScrollPosX = me._text_scroll_reading_2.ggScrollPosXPercent * me._text_scroll_reading_2.ggAvailableWidth;
					me._text_scroll_reading_2.ggScrollPosX = Math.min(me._text_scroll_reading_2.ggScrollPosX, me._text_scroll_reading_2__horScrollBg.offsetWidth - me._text_scroll_reading_2__horScrollFg.offsetWidth);
					me._text_scroll_reading_2__horScrollFg.style.left = me._text_scroll_reading_2.ggScrollPosX + 'px';
					if (me._text_scroll_reading_2.ggHPercentVisible < 1.0) {
						let percentScrolled = me._text_scroll_reading_2.ggScrollPosX / (me._text_scroll_reading_2__horScrollBg.offsetWidth - me._text_scroll_reading_2__horScrollFg.offsetWidth);
						me._text_scroll_reading_2__content.style.left = -(Math.round((me._text_scroll_reading_2.ggContentWidth * (1.0 - me._text_scroll_reading_2.ggHPercentVisible)) * percentScrolled)) + this.ggContentLeftOffset + 'px';
					}
				} else {
					me._text_scroll_reading_2.ggAvailableHeight = me._text_scroll_reading_2.clientHeight;
					me._text_scroll_reading_2.ggScrollPosX = 0;
					me._text_scroll_reading_2.ggScrollPosXPercent = 0.0;
					me._text_scroll_reading_2__content.style.left = this.ggContentLeftOffset + 'px';
				}
				if(me._text_scroll_reading_2.ggVertScrollVisible) {
					me._text_scroll_reading_2.ggAvailableWidth = me._text_scroll_reading_2.clientWidth - 15;
					if (me._text_scroll_reading_2.ggHorScrollVisible) {
						me._text_scroll_reading_2.ggAvailableHeight = me._text_scroll_reading_2.clientHeight - 15;
						me._text_scroll_reading_2.ggAvailableHeightWithScale = me._text_scroll_reading_2.getBoundingClientRect().height - me._text_scroll_reading_2__vertScrollBg.getBoundingClientRect().width;
						me._text_scroll_reading_2__cornerBg.style.visibility = 'inherit';
					} else {
						me._text_scroll_reading_2.ggAvailableHeight = me._text_scroll_reading_2.clientHeight;
						me._text_scroll_reading_2.ggAvailableHeightWithScale = me._text_scroll_reading_2.getBoundingClientRect().height;
						me._text_scroll_reading_2__cornerBg.style.visibility = 'hidden';
					}
					me._text_scroll_reading_2__vertScrollBg.style.height = me._text_scroll_reading_2.ggAvailableHeight + 'px';
					me._text_scroll_reading_2.ggVPercentVisible = contentHeight != 0 ? me._text_scroll_reading_2.ggAvailableHeightWithScale / contentHeight : 0.0;
					if (me._text_scroll_reading_2.ggVPercentVisible > 1.0) me._text_scroll_reading_2.ggVPercentVisible = 1.0;
					me._text_scroll_reading_2.ggScrollHeight =  Math.round(me._text_scroll_reading_2__vertScrollBg.offsetHeight * me._text_scroll_reading_2.ggVPercentVisible);
					me._text_scroll_reading_2__vertScrollFg.style.height = me._text_scroll_reading_2.ggScrollHeight + 'px';
					me._text_scroll_reading_2.ggScrollPosY = me._text_scroll_reading_2.ggScrollPosYPercent * me._text_scroll_reading_2.ggAvailableHeight;
					me._text_scroll_reading_2.ggScrollPosY = Math.min(me._text_scroll_reading_2.ggScrollPosY, me._text_scroll_reading_2__vertScrollBg.offsetHeight - me._text_scroll_reading_2__vertScrollFg.offsetHeight);
					me._text_scroll_reading_2__vertScrollFg.style.top = me._text_scroll_reading_2.ggScrollPosY + 'px';
					if (me._text_scroll_reading_2.ggVPercentVisible < 1.0) {
						let percentScrolled = me._text_scroll_reading_2.ggScrollPosY / (me._text_scroll_reading_2__vertScrollBg.offsetHeight - me._text_scroll_reading_2__vertScrollFg.offsetHeight);
						me._text_scroll_reading_2__content.style.top = -(Math.round((me._text_scroll_reading_2.ggContentHeight * (1.0 - me._text_scroll_reading_2.ggVPercentVisible)) * percentScrolled)) + me._text_scroll_reading_2.ggContentTopOffset + 'px';
					}
				} else {
					...
					me._text_scroll_reading_2.ggScrollPosY = 0;
					me._text_scroll_reading_2.ggScrollPosYPercent = 0.0;
					me._text_scroll_reading_2__content.style.top = this.ggContentTopOffset + 'px';
					me._text_scroll_reading_2__cornerBg.style.visibility = 'hidden';
				}
				if(horScrollWasVisible != me._text_scroll_reading_2.ggHorScrollVisible || vertScrollWasVisible != me._text_scroll_reading_2.ggVertScrollVisible) {
					skin.updateSize(me._text_scroll_reading_2);
					me._text_scroll_reading_2.ggUpdatePosition();
				}
			}
		}
		el=me._text_info_reading_2=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._text_info_reading_2;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		els=me._text_info_reading_2__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="text_info_reading_2";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_text ";
		el.ggType='text';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._text_info_reading_2.ggUpdateText=function() {
			var params = [];
			var hs = player._("<div class=\"ggmarkdown\"><h1>\u043a\u043e\u0440\u0430\u0431\u043b\u0438 \u0432\u0435\u0434\u0443\u0442 \u0430\u0440\u0442\u0438\u043b\u043b\u0435\u0440\u0438\u0439\u0441\u043a\u0438\u0439 \u0431\u043e\u0439, \u0432\u043e\u043a\u0440\u0443\u0433 \u0432\u0438\u0434\u043d\u044b \u0434\u044b\u043c, \u0432\u0441\u043f\u043b\u0435\u0441\u043a\u0438 \u043e\u0442 \u044f\u0434\u0435\u0440 \u0438 \u0431\u043e\u0435\u0432\u044b\u0435<\/h1>\n<p>\u043f\u043e\u0440\u044f\u0434\u043a\u0438 \u044d\u0441\u043a\u0430\u0434\u0440. \u0422\u0430\u043a\u0438\u0435 \u043f\u043e\u043b\u043e\u0442\u043d\u0430 \u0431\u044b\u043b\u0438 \u0441\u043e\u0437\u0434\u0430\u043d\u044b \u0425\u0430\u043a\u043a\u0435\u0440\u0442\u043e\u043c \u043f\u043e \u0437\u0430\u043a\u0430\u0437\u0443 \u0415\u043a\u0430\u0442\u0435\u0440\u0438\u043d\u044b II \u0434\u043b\u044f\n\u0443\u0432\u0435\u043a\u043e\u0432\u0435\u0447\u0435\u043d\u0438\u044f \u043f\u043e\u0431\u0435\u0434 \u0440\u0443\u0441\u0441\u043a\u043e\u0433\u043e \u0444\u043b\u043e\u0442\u0430 \u0432 \u0410\u0440\u0445\u0438\u043f\u0435\u043b\u0430\u0433\u0441\u043a\u043e\u0439 \u044d\u043a\u0441\u043f\u0435\u0434\u0438\u0446\u0438\u0438. \u0421\u044e\u0436\u0435\u0442 \u0441\u0432\u044f\u0437\u0430\u043d \u0441\n\u0441\u043e\u0431\u044b\u0442\u0438\u044f\u043c\u0438 \u0443 \u043e\u0441\u0442\u0440\u043e\u0432\u0430 \u0425\u0438\u043e\u0441 \u0438 \u0432 \u0440\u0430\u0439\u043e\u043d\u0435 \u0427\u0435\u0441\u043c\u0435\u043d\u0441\u043a\u043e\u0439 \u0431\u0443\u0445\u0442\u044b \u0432 \u0438\u044e\u043d\u0435 1770 \u0433\u043e\u0434\u0430, \u043f\u043e\u0441\u043b\u0435\n\u043a\u043e\u0442\u043e\u0440\u044b\u0445 \u0442\u0443\u0440\u0435\u0446\u043a\u0438\u0439 \u0444\u043b\u043e\u0442 \u043e\u043a\u0430\u0437\u0430\u043b\u0441\u044f \u0437\u0430\u043f\u0435\u0440\u0442 \u0432 \u0431\u0443\u0445\u0442\u0435 \u0438 \u0431\u044b\u043b \u0443\u043d\u0438\u0447\u0442\u043e\u0436\u0435\u043d \u0432 \u043d\u043e\u0447\u043d\u043e\u0439 \u0430\u0442\u0430\u043a\u0435.\n\u0433\u043e\u0440\u044f\u0449\u0438\u0435 \u043a\u043e\u0440\u0430\u0431\u043b\u0438 \u043e\u0441\u043c\u0430\u043d\u0441\u043a\u043e\u0433\u043e \u0444\u043b\u043e\u0442\u0430 \u0432 \u0431\u0443\u0445\u0442\u0435. \u0412 \u043d\u043e\u0447\u044c \u043d\u0430 26 \u0438\u044e\u043d\u044f 1770 \u0433\u043e\u0434\u0430 \u043f\u043e\n\u0441\u0442\u0430\u0440\u043e\u043c\u0443 \u0441\u0442\u0438\u043b\u044e \u0440\u0443\u0441\u0441\u043a\u0430\u044f \u044d\u0441\u043a\u0430\u0434\u0440\u0430 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043b\u0430 \u0430\u0440\u0442\u0438\u043b\u043b\u0435\u0440\u0438\u0439\u0441\u043a\u0438\u0439 \u043e\u0433\u043e\u043d\u044c \u0438 \u0431\u0440\u0430\u043d\u0434\u0435\u0440\u044b \u2014\n\u0441\u043f\u0435\u0446\u0438\u0430\u043b\u044c\u043d\u044b\u0435 \u0437\u0430\u0436\u0438\u0433\u0430\u0442\u0435\u043b\u044c\u043d\u044b\u0435 \u0441\u0443\u0434\u0430. \u0421\u043a\u0443\u0447\u0435\u043d\u043d\u043e\u0441\u0442\u044c \u0442\u0443\u0440\u0435\u0446\u043a\u0438\u0445 \u043a\u043e\u0440\u0430\u0431\u043b\u0435\u0439 \u0432 \u0431\u0443\u0445\u0442\u0435 \u0443\u0441\u0438\u043b\u0438\u043b\u0430\n\u044d\u0444\u0444\u0435\u043a\u0442 \u043f\u043e\u0436\u0430\u0440\u0430: \u043f\u043b\u0430\u043c\u044f \u0431\u044b\u0441\u0442\u0440\u043e \u043f\u0435\u0440\u0435\u043a\u0438\u043d\u0443\u043b\u043e\u0441\u044c \u0441 \u043e\u0434\u043d\u043e\u0433\u043e \u0441\u0443\u0434\u043d\u0430 \u043d\u0430 \u0434\u0440\u0443\u0433\u043e\u0435. \u041a\u0430\u0440\u0442\u0438\u043d\u0430\n\u043f\u0435\u0440\u0435\u0434\u0430\u0435\u0442 \u043c\u0430\u0441\u0448\u0442\u0430\u0431 \u043a\u0430\u0442\u0430\u0441\u0442\u0440\u043e\u0444\u044b \u0438 \u043f\u043e\u043a\u0430\u0437\u044b\u0432\u0430\u0435\u0442, \u043f\u043e\u0447\u0435\u043c\u0443 \u0427\u0435\u0441\u043c\u0430 \u0441\u0442\u0430\u043b\u0430 \u043e\u0434\u043d\u043e\u0439 \u0438\u0437 \u0433\u043b\u0430\u0432\u043d\u044b\u0445\n\u043c\u043e\u0440\u0441\u043a\u0438\u0445 \u043f\u043e\u0431\u0435\u0434 \u0420\u043e\u0441\u0441\u0438\u0438 XVIII \u0432\u0435\u043a\u0430.<\/p>\n<p>\u041a\u0430\u0440\u0442\u0438\u043d\u0430 \u0410\u0439\u0432\u0430\u0437\u043e\u0432\u0441\u043a\u043e\u0433\u043e \u043f\u043e\u0441\u0432\u044f\u0449\u0435\u043d\u0430 \u0442\u043e\u0439 \u0436\u0435 \u043f\u043e\u0431\u0435\u0434\u0435\n\u0440\u0443\u0441\u0441\u043a\u043e\u0433\u043e \u0444\u043b\u043e\u0442\u0430 \u043f\u0440\u0438 \u0427\u0435\u0441\u043c\u0435, \u043d\u043e \u043d\u0430\u043f\u0438\u0441\u0430\u043d\u0430 \u0443\u0436\u0435 \u0432 XIX \u0432\u0435\u043a\u0435. \u0425\u0443\u0434\u043e\u0436\u043d\u0438\u043a \u0434\u0435\u043b\u0430\u0435\u0442 \u0430\u043a\u0446\u0435\u043d\u0442 \u043d\u0435\n\u043d\u0430 \u0434\u043e\u043a\u0443\u043c\u0435\u043d\u0442\u0430\u043b\u044c\u043d\u043e\u0439 \u0441\u0445\u0435\u043c\u0435 \u0431\u043e\u044f, \u0430 \u043d\u0430 \u044d\u043c\u043e\u0446\u0438\u043e\u043d\u0430\u043b\u044c\u043d\u043e\u043c \u0432\u043f\u0435\u0447\u0430\u0442\u043b\u0435\u043d\u0438\u0438: \u043d\u043e\u0447\u043d\u043e\u0435 \u043c\u043e\u0440\u0435,\n\u043b\u0443\u043d\u043d\u044b\u0439 \u0441\u0432\u0435\u0442, \u043f\u043b\u0430\u043c\u044f, \u0434\u044b\u043c \u0438 \u0441\u0438\u043b\u0443\u044d\u0442\u044b \u043a\u043e\u0440\u0430\u0431\u043b\u0435\u0439 \u0441\u043e\u0437\u0434\u0430\u044e\u0442 \u044d\u0444\u0444\u0435\u043a\u0442 \u0433\u0440\u0430\u043d\u0434\u0438\u043e\u0437\u043d\u043e\u0439 \u043c\u043e\u0440\u0441\u043a\u043e\u0439\n\u043a\u0430\u0442\u0430\u0441\u0442\u0440\u043e\u0444\u044b. \u041d\u0430 \u043f\u043e\u043b\u043e\u0442\u043d\u0435 \u043f\u043e\u043a\u0430\u0437\u0430\u043d\u0430 \u043a\u0443\u043b\u044c\u043c\u0438\u043d\u0430\u0446\u0438\u044f \u043d\u043e\u0447\u043d\u043e\u0439 \u0430\u0442\u0430\u043a\u0438, \u043a\u043e\u0433\u0434\u0430 \u0442\u0443\u0440\u0435\u0446\u043a\u0438\u0439 \u0444\u043b\u043e\u0442\n\u0433\u043e\u0440\u0438\u0442 \u0432 \u0427\u0435\u0441\u043c\u0435\u043d\u0441\u043a\u043e\u0439 \u0431\u0443\u0445\u0442\u0435. \u0414\u043b\u044f \u0438\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0438\u043e\u043d\u043d\u043e\u0439 \u043f\u0430\u043d\u0435\u043b\u0438 \u043c\u043e\u0436\u043d\u043e \u043e\u0442\u043c\u0435\u0442\u0438\u0442\u044c, \u0447\u0442\u043e\n\u0410\u0439\u0432\u0430\u0437\u043e\u0432\u0441\u043a\u0438\u0439 \u043f\u0440\u0435\u0432\u0440\u0430\u0442\u0438\u043b \u0438\u0441\u0442\u043e\u0440\u0438\u0447\u0435\u0441\u043a\u0438\u0439 \u044d\u043f\u0438\u0437\u043e\u0434 \u0432 \u044f\u0440\u043a\u0438\u0439 \u0440\u043e\u043c\u0430\u043d\u0442\u0438\u0447\u0435\u0441\u043a\u0438\u0439 \u043e\u0431\u0440\u0430\u0437 \u043c\u043e\u0440\u0441\u043a\u043e\u0439\n\u043f\u043e\u0431\u0435\u0434\u044b.<\/p>\n<p>\u041f\u043e\u043b\u043e\u0442\u043d\u043e \u043f\u043e\u043a\u0430\u0437\u044b\u0432\u0430\u0435\u0442 \u0434\u043d\u0435\u0432\u043d\u0443\u044e \u0444\u0430\u0437\u0443 \u043c\u043e\u0440\u0441\u043a\u043e\u0433\u043e \u0441\u0442\u043e\u043b\u043a\u043d\u043e\u0432\u0435\u043d\u0438\u044f \u043c\u0435\u0436\u0434\u0443 \u0440\u0443\u0441\u0441\u043a\u043e\u0439 \u0438\n\u0442\u0443\u0440\u0435\u0446\u043a\u043e\u0439 \u044d\u0441\u043a\u0430\u0434\u0440\u0430\u043c\u0438. 24 \u0438\u044e\u043d\u044f 1770 \u0433\u043e\u0434\u0430 \u043f\u043e \u0441\u0442\u0430\u0440\u043e\u043c\u0443 \u0441\u0442\u0438\u043b\u044e \u043f\u0440\u043e\u0438\u0437\u043e\u0448\u0435\u043b \u0431\u043e\u0439 \u0443 \u0425\u0438\u043e\u0441\u0430,\n\u043f\u0440\u0435\u0434\u0448\u0435\u0441\u0442\u0432\u043e\u0432\u0430\u0432\u0448\u0438\u0439 \u0440\u0435\u0448\u0430\u044e\u0449\u0435\u043c\u0443 \u043d\u043e\u0447\u043d\u043e\u043c\u0443 \u0443\u0434\u0430\u0440\u0443 \u0432 \u0427\u0435\u0441\u043c\u0435\u043d\u0441\u043a\u043e\u0439 \u0431\u0443\u0445\u0442\u0435. \u041f\u043e\u0441\u043b\u0435 \u0442\u044f\u0436\u0435\u043b\u043e\u0433\u043e \u0431\u043e\u044f\n\u0442\u0443\u0440\u0435\u0446\u043a\u0438\u0435 \u043a\u043e\u0440\u0430\u0431\u043b\u0438 \u043e\u0442\u043e\u0448\u043b\u0438 \u0432 \u0431\u0443\u0445\u0442\u0443 \u0427\u0435\u0441\u043c\u0430, \u0433\u0434\u0435 \u043e\u043a\u0430\u0437\u0430\u043b\u0438\u0441\u044c \u0432 \u043d\u0435\u0432\u044b\u0433\u043e\u0434\u043d\u043e\u043c \u043f\u043e\u043b\u043e\u0436\u0435\u043d\u0438\u0438.\n\u041f\u043e\u044d\u0442\u043e\u043c\u0443 \u044d\u0442\u043e\u0442 \u0441\u044e\u0436\u0435\u0442 \u0443\u0434\u043e\u0431\u043d\u043e \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u044c \u043a\u0430\u043a \xab\u043f\u0440\u0435\u0434\u044b\u0441\u0442\u043e\u0440\u0438\u044e\xbb \u0433\u043b\u0430\u0432\u043d\u043e\u0439 \u0441\u0446\u0435\u043d\u044b\n\u0427\u0435\u0441\u043c\u0435\u043d\u0441\u043a\u043e\u0433\u043e \u0431\u043e\u044f: \u0441\u043d\u0430\u0447\u0430\u043b\u0430 \u0430\u0440\u0442\u0438\u043b\u043b\u0435\u0440\u0438\u0439\u0441\u043a\u043e\u0435 \u0441\u0442\u043e\u043b\u043a\u043d\u043e\u0432\u0435\u043d\u0438\u0435 \u043d\u0430 \u043c\u043e\u0440\u0435, \u0437\u0430\u0442\u0435\u043c \u043d\u043e\u0447\u043d\u043e\u0435\n\u0443\u043d\u0438\u0447\u0442\u043e\u0436\u0435\u043d\u0438\u0435 \u0444\u043b\u043e\u0442\u0430 \u0432 \u0431\u0443\u0445\u0442\u0435.<\/p>\n<div>", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_info_reading_2.ggUpdateText();
		el.appendChild(els);
		me._text_info_reading_2.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._text_info_reading_2.ggUpdatePosition=function (useTransition) {
		}
		me._text_scroll_reading_2__content.appendChild(me._text_info_reading_2);
		me._rectangle_2.appendChild(me._text_scroll_reading_2);
		me._info_popup_2galery.appendChild(me._rectangle_2);
		me.divSkin.appendChild(me._info_popup_2galery);
		...
		el=me._btn_close=document.createElement('div');
		els=me._btn_close__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="btn_close";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._btn_close.ggUpdateText=function() {
			var params = [];
			var hs = player._("X", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
		...
		me._btn_close.ggUpdateText();
		el.appendChild(els);
		me._btn_close.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._btn_close.onclick=function (e) {
			if (player.transitionsDisabled) {
				me._info_popup.style.transition='none';
			} else {
				me._info_popup.style.transition='all 400ms ease-out 0ms';
			}
			me._info_popup.ggParameter.rx=0;me._info_popup.ggParameter.ry=0;
			me._info_popup.style.transform=parameterToTransform(me._info_popup.ggParameter);
		}
		me._btn_close.ggUpdatePosition=function (useTransition) {
		}
		me._rectangle_1.appendChild(me._btn_close);
		...
		me._text_info.ggUpdateText=function() {
			var params = [];
			var hs = player._("<div class=\"ggmarkdown\"><h4>\u0427\u0435\u0441\u043c\u0435\u0301\u043d\u0441\u043a\u0438\u0439 \u0434\u0432\u043e\u0440\u0435\u0301\u0446 \u2014 \u0438\u043c\u043f\u0435\u0440\u0430\u0442\u043e\u0440\u0441\u043a\u0438\u0439 \u043f\u0443\u0442\u0435\u0432\u043e\u0439 \u0434\u0432\u043e\u0440\u0435\u0446, \u0440\u0430\u0441\u043f\u043e\u043b\u043e\u0436\u0435\u043d\u043d\u044b\u0439 \u0432 \u0421\u0430\u043d\u043a\u0442<\/h4>\n<p>\u041f\u0435\u0442\u0435\u0440\u0431\u0443\u0440\u0433\u0435. \u0412\u043e\u0437\u0432\u0435\u0434\u0451\u043d \u043f\u043e \u043f\u0440\u043e\u0435\u043a\u0442\u0443 \u0430\u0440\u0445\u0438\u0442\u0435\u043a\u0442\u043e\u0440\u0430 \u042e. \u041c. \u0424\u0435\u043b\u044c\u0442\u0435\u043d\u0430 \u043f\u043e \u0437\u0430\u043a\u0430\u0437\u0443\n\u0438\u043c\u043f\u0435\u0440\u0430\u0442\u0440\u0438\u0446\u044b \u0415\u043a\u0430\u0442\u0435\u0440\u0438\u043d\u044b \u0412\u0442\u043e\u0440\u043e\u0439 \u0432 \u0441\u0442\u0438\u043b\u0435 \u043d\u0435\u043e\u0433\u043e\u0442\u0438\u043a\u0438. \u041f\u0430\u043c\u044f\u0442\u043d\u0438\u043a \u0430\u0440\u0445\u0438\u0442\u0435\u043a\u0442\u0443\u0440\u044b. \u0412\u043c\u0435\u0441\u0442\u0435 \u0441\n\u0427\u0435\u0441\u043c\u0435\u043d\u0441\u043a\u043e\u0439 \u0446\u0435\u0440\u043a\u043e\u0432\u044c\u044e \u0441\u043e\u0441\u0442\u0430\u0432\u043b\u044f\u043b \u043d\u0435\u043a\u043e\u0433\u0434\u0430 \u0443\u043d\u0438\u043a\u0430\u043b\u044c\u043d\u044b\u0439 \u0430\u043d\u0441\u0430\u043c\u0431\u043b\u044c, \u043e\u0431\u0440\u0430\u0449\u0451\u043d\u043d\u044b\u0439 \u043a \u0431\u044b\u0432\u0448\u0435\u043c\u0443\n\u0426\u0430\u0440\u0441\u043a\u043e\u0441\u0435\u043b\u044c\u0441\u043a\u043e\u043c\u0443 \u0442\u0440\u0430\u043a\u0442\u0443 (\u0442\u0435\u043f\u0435\u0440\u044c \u041c\u043e\u0441\u043a\u043e\u0432\u0441\u043a\u0438\u0439 \u043f\u0440\u043e\u0441\u043f\u0435\u043a\u0442). \u041d\u0430\u0437\u0432\u0430\u043d \u0432 \u0447\u0435\u0441\u0442\u044c \u043f\u043e\u0431\u0435\u0434\u044b\n\u0440\u0443\u0441\u0441\u043a\u043e\u0433\u043e \u0444\u043b\u043e\u0442\u0430 \u043d\u0430\u0434 \u0442\u0443\u0440\u0435\u0446\u043a\u0438\u043c \u0432 \u0427\u0435\u0441\u043c\u0435\u043d\u0441\u043a\u043e\u043c \u0441\u0440\u0430\u0436\u0435\u043d\u0438\u0438 1770 \u0433\u043e\u0434\u0430.<\/p>\n<div>", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._rectangle_1.appendChild(me._text_info);
		...
		hs='data:image/svg+xml;base64,'+
			''+
		...
		hs='data:image/svg+xml;base64,'+
			'9wYWNpdHk6MSIvPgogIDxsaW5lIHgyPSIxNy42NCIgeDE9IjQ4IiB5Mj0iMzIiIHkxPSIzMiIgc3R5bGU9ImZpbGw6bm9uZTtzdHJva2U6IzAwMDAwMDtzdHJva2UtbWl0ZXJsaW1pdDoxMDtzdHJva2Utd2lkdGg6NHB4OyBzdHJva2Utb3BhY2l0eToxIi8+CiA8L2c+Cjwvc3ZnPgo=';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'c+Cg==';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			'0iMzIiIHgxPSIzMiIgeTI9IjQ4IiB5MT0iMTYiIHN0eWxlPSJmaWxsOm5vbmU7c3Ryb2tlOiMwMDAwMDA7c3Ryb2tlLW1pdGVybGltaXQ6MTA7c3Ryb2tlLXdpZHRoOjRweDsgc3Ryb2tlLW9wYWNpdHk6MSIvPgogPC9nPgo8L3N2Zz4K';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'eTI9IjMyIiB5MT0iMzIiIGNsYXNzPSJzdDEiLz4KIDwvZz4KPC9zdmc+Cg==';
		...
		hs='data:image/svg+xml;base64,'+
			'9wYWNpdHk6MSIvPgogIDxsaW5lIHgyPSI0Ni4zNiIgeDE9IjE2IiB5Mj0iMzIiIHkxPSIzMiIgc3R5bGU9ImZpbGw6bm9uZTtzdHJva2U6IzAwMDAwMDtzdHJva2UtbWl0ZXJsaW1pdDoxMDtzdHJva2Utd2lkdGg6NHB4OyBzdHJva2Utb3BhY2l0eToxIi8+CiA8L2c+Cjwvc3ZnPgo=';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'eDk7IiBjbGFzcz0ic3QxIi8+CiAgPGxpbmUgeDI9IjMyIiB4MT0iMzIiIHkyPSI0Ni40IiB5MT0iMTYiIGNsYXNzPSJzdDEiLz4KIDwvZz4KPC9zdmc+Cg==';
		...
		hs='data:image/svg+xml;base64,'+
			'';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
	...
	function SkinHotspotClass_ht_info_popup(parentScope,hotspot) {
		var me=this;
		var flag=false;
		var hs='';
		me.parentScope=parentScope;
		...
		me._ht_info_popup.onclick=function (e) {
			player.triggerEvent('hsproxyclick', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._ht_info_popup.ondblclick=function (e) {
			player.triggerEvent('hsproxydblclick', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		...
		me._image_3.onclick=function (e) {
			if (player.transitionsDisabled) {
				...
				skin._info_popup.style.transition='all 700ms ease-out 0ms';
			}
			skin._info_popup.ggParameter.rx=0;skin._info_popup.ggParameter.ry=750;
			skin._info_popup.style.transform=parameterToTransform(skin._info_popup.ggParameter);
		}
		me._image_3.ggUpdatePosition=function (useTransition) {
		}
		me._ht_info_popup.appendChild(me._image_3);
		me.elementMouseOver['ht_info_popup']=false;
			me.__div = me._ht_info_popup;
	};
	function SkinHotspotClass_ht_info_reading_2(parentScope,hotspot) {
		var me=this;
		var flag=false;
		var hs='';
		me.parentScope=parentScope;
		...
		el=me._ht_info_reading_2=document.createElement('div');
		el.ggId="ht_info_reading_2";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_hotspot ";
		el.ggType='hotspot';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._ht_info_reading_2.ggIsActive=function() {
			return player.getCurrentNode()==this.ggElementNodeId();
		}
		el.ggElementNodeId=function() {
			if (me.hotspot.url!='' && me.hotspot.url.charAt(0)=='{') { // }
		...
		me._ht_info_reading_2.onclick=function (e) {
			player.triggerEvent('hsproxyclick', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._ht_info_reading_2.ondblclick=function (e) {
			player.triggerEvent('hsproxydblclick', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._ht_info_reading_2.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['ht_info_reading_2']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._ht_info_reading_2.onmouseleave=function (e) {
			me.elementMouseOver['ht_info_reading_2']=false;
			player.triggerEvent('hsproxyout', {'id': me.hotspot.id, 'url': me.hotspot.url});
			player.setActiveHotspot(null);
		}
		me._ht_info_reading_2.ggUpdatePosition=function (useTransition) {
		}
		...
		me._image_30.onclick=function (e) {
			if (player.transitionsDisabled) {
				skin._info_popup_2galery.style.transition='none';
			} else {
				skin._info_popup_2galery.style.transition='all 1000ms ease-out 0ms';
			}
			skin._info_popup_2galery.ggParameter.rx=0;skin._info_popup_2galery.ggParameter.ry=700;
			skin._info_popup_2galery.style.transform=parameterToTransform(skin._info_popup_2galery.ggParameter);
		}
		me._image_30.ggUpdatePosition=function (useTransition) {
		}
		me._ht_info_reading_2.appendChild(me._image_30);
		me.elementMouseOver['ht_info_reading_2']=false;
			me.__div = me._ht_info_reading_2;
	};
	function SkinHotspotClass_ht_info_reading_3(parentScope,hotspot) {
		var me=this;
		var flag=false;
		var hs='';
		me.parentScope=parentScope;
		...
		el=me._ht_info_reading_3=document.createElement('div');
		el.ggId="ht_info_reading_3";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_hotspot ";
		el.ggType='hotspot';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._ht_info_reading_3.ggIsActive=function() {
			return player.getCurrentNode()==this.ggElementNodeId();
		}
		el.ggElementNodeId=function() {
			if (me.hotspot.url!='' && me.hotspot.url.charAt(0)=='{') { // }
		...
		me._ht_info_reading_3.onclick=function (e) {
			player.triggerEvent('hsproxyclick', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._ht_info_reading_3.ondblclick=function (e) {
			player.triggerEvent('hsproxydblclick', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._ht_info_reading_3.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['ht_info_reading_3']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._ht_info_reading_3.onmouseleave=function (e) {
			me.elementMouseOver['ht_info_reading_3']=false;
			player.triggerEvent('hsproxyout', {'id': me.hotspot.id, 'url': me.hotspot.url});
			player.setActiveHotspot(null);
		}
		me._ht_info_reading_3.ggUpdatePosition=function (useTransition) {
		}
		...
		me._image_31.onclick=function (e) {
			if (player.transitionsDisabled) {
				skin._info_popup_3galery.style.transition='none';
			} else {
				skin._info_popup_3galery.style.transition='all 1000ms ease-out 0ms';
			}
			skin._info_popup_3galery.ggParameter.rx=0;skin._info_popup_3galery.ggParameter.ry=700;
			skin._info_popup_3galery.style.transform=parameterToTransform(skin._info_popup_3galery.ggParameter);
		}
		me._image_31.ggUpdatePosition=function (useTransition) {
		}
		me._ht_info_reading_3.appendChild(me._image_31);
		me.elementMouseOver['ht_info_reading_3']=false;
			me.__div = me._ht_info_reading_3;
	};
	me.addSkinHotspot=function(hotspot) {
		var hsinst = null;
			if (hotspot.skinid=='ht_info_reading_3') {
				hotspot.skinid = 'ht_info_reading_3';
				hsinst = new SkinHotspotClass_ht_info_reading_3(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
		} else
			if (hotspot.skinid=='ht_info_reading_2') {
				hotspot.skinid = 'ht_info_reading_2';
				hsinst = new SkinHotspotClass_ht_info_reading_2(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
		} else
			if (hotspot.skinid=='ht_info_popup') {
				hotspot.skinid = 'ht_info_popup';
				hsinst = new SkinHotspotClass_ht_info_popup(me, hotspot);
			if (!hotspotTemplates.hasOwnProperty(hotspot.skinid)) {
				hotspotTemplates[hotspot.skinid] = [];
			}
			hotspotTemplates[hotspot.skinid].push(hsinst);
